      ...
      {isOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6 md:p-8">
          ...
          <motion.div 
            ...
            className="relative z-10 w-full max-w-5xl bg-white rounded-2xl md:rounded-[24px] shadow-2xl overflow-hidden flex flex-col md:flex-row max-h-[90vh] md:max-h-none overflow-y-auto md:overflow-y-visible"
          >
            {/* Close Button */}
            <button 
              onClick={() => setIsOpen(false)}
            ...
            <div className="w-full md:w-[45%] lg:w-[40%] bg-[#1a2b3c] p-8 md:p-10 flex flex-col text-white relative overflow-hidden shrink-0">
               ...
               <div className="relative z-10 h-full flex flex-col">
                 ...
                 <h2 className="text-3xl md:text-4xl lg:text-[40px] font-bold text-white mb-4 leading-[1.15]">
                   Start Your IEPF & Share Recovery Review
                 </h2>
                 <p className="text-blue-100/80 text-sm md:text-[15px] mb-8 leading-relaxed">
                   Share your details and our team will review your case for IEPF claim, lost shares, dividend recovery, legal heir support, or physical share conversion.
                 </p>

                 <div className="space-y-3 mt-auto">
                   {[
                     "IEPF Form-5 assistance",
                     "Company and RTA coordination",
                     "Lost share certificate guidance",
                     "Legal heir and nominee cases"
                   ].map((item, idx) => (
